...
#include "TwoSThermalTestStructureSVG.h"
#include "Thermo2TwoSThermalTestStructureWidget.h"

TwoSThermalTestStructureSVGWidget::TwoSThermalTestStructureSVGWidget(QWidget* parent)
  : QSvgWidget(parent)
{
...
int TwoSThermalTestStructureSVGWidget::heightForWidth(int w) const
{
  return w*500/920;
}

int TwoSThermalTestStructureSVGWidget::widthForHeight(int h) const
{
  return h*920/500;
}

void TwoSThermalTestStructureSVGWidget::resizeEvent(QResizeEvent *event)
{
  QSize s = event->size();
...
Thermo2TwoSThermalTestStructureWidget::Thermo2TwoSThermalTestStructureWidget(Thermo2TwoSThermalTestStructureModel* model,
		QWidget *parent)
 : QWidget(parent),
   model_(model)
{
  ...
  svgWidget_ = new TwoSThermalTestStructureSVGWidget(this);
  svgWidget_->setMinimumWidth(920);
  svgWidget_->setMinimumHeight(svgWidget_->heightForWidth(920));
...
void Thermo2TwoSThermalTestStructureWidget::mattermostChanged()
{
  model_->setMattermostStatus(mattermostStatus_->isChecked());
}

void Thermo2TwoSThermalTestStructureWidget::updateInfo()
{
  QString svg = TwoSThermalTestStructureSVGString;
